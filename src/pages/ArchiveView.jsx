...
function ArchiveCard({ project, index = 0, reduced = false }) {
  ...
  const formattedDate =
    project?.date?.length === 4
      ? `FEB ${project.date}`
      : project?.date?.toUpperCase() || "2026";
  ...
  return (
    <section className="relative w-full h-full flex flex-col bg-gradient-to-b from-[#161616] to-[#0c0c0c] text-white py-12 md:py-20 overflow-hidden select-none">
      {/* Background Ambience */}
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[800px] bg-white/[0.02] rounded-full blur-[120px]" />
      ...
      <motion.div
        className="relative z-10 mx-auto w-full max-w-[1500px] px-4 sm:px-6 md:px-10 lg:px-12 flex-1 flex flex-col justify-between"
      ...
      >
        ...
        <div className="w-full">
          ...
          {/* 2. Project Title (Original text style & size with uniform min-height block) */}
          <motion.h1
            variants={titleVariants}
            className="font-extrabold text-white tracking-tight mb-10 text-[36px] sm:text-[48px] md:text-[60px] lg:text-[72px] leading-[1.05] line-clamp-2 min-h-[2.1em]"
          >
            {project?.title}
          </motion.h1>
          ...
          >
            ...
            <div className="flex items-start justify-between gap-6 mb-8 md:mb-12 min-h-[48px] md:min-h-[58px]">
              <p className="font-semibold text-white/90 leading-[1.3] max-w-[85%] text-[12px] sm:text-[14px] md:text-[18px] line-clamp-3">
            ...
            <div className="group relative w-full aspect-[3/2] md:aspect-[16/10] overflow-hidden rounded-lg border border-white/[0.08] bg-black/40">
              <img
                src={project?.image}
              ...
              {/* faint top sheen for a "browser window" feel */}
        ...
        <motion.div
          className="flex flex-wrap gap-3 items-center mt-auto"
          variants={reduced ? {} : containerVariants}
        >
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1500px] mx-auto px-5 sm:px-8 lg:px-32">
        ...
        <motion.div
          ...
          {...mp({ opacity: 0, x: -20 }, { opacity: 1, x: 0 }, undefined, {
            duration: 0.5,
            delay: 0.1,
          })}
        >
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <motion.div
            ...
            {...mp({ opacity: 0, y: 16 }, { opacity: 1, y: 0 }, undefined, {
              duration: 0.6,
            })}
          >
            <div
          ...
          <motion.h1
            ...
            {...mp({ opacity: 0, x: -30 }, { opacity: 1, x: 0 }, undefined, {
              duration: 0.8,
              delay: 0.1,
            })}
          >
          ...
          <motion.p
            ...
            {...mp({ opacity: 0, y: 20 }, { opacity: 1, y: 0 }, undefined, {
              duration: 0.7,
              delay: 0.2,
            })}
          >
            A curated collection of web applications, experiments, and digital
            experiences built with modern technologies and a focus on design
            systems.
          </motion.p>
        </div>
