      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 pt-10">
          ...
          <div className="flex-1 w-full flex flex-col gap-12">
            <section>
              <h3 className="font-mono text-[12px] tracking-[0.2em] uppercase text-white/40 mb-4">
                The Problem
              </h3>
              <p className="font-geist text-[16px] leading-[1.8] text-white/70">
                {project.problem}
              </p>
            </section>
              ...
              <ul className="flex flex-col gap-3">
                {project.features?.map((f, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="font-geist text-[16px] leading-[1.7] text-white/70">
                      {f}
                    </span>
                  </li>
                ))}
          ...
          <div className="w-full lg:w-[320px] flex-shrink-0">
            <div className="sticky top-32 flex flex-col gap-8 p-8 rounded-none bg-white/[0.02] border border-white/10">
              <div>
                <h4 className="font-mono text-[10px] tracking-[0.2em] uppercase text-white/30 mb-3">
                  Tech Stack
                </h4>
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((t) => (
                    <span
                      key={t}
                      className="px-3 py-1.5 rounded-full border border-white/10 bg-white/5 font-mono text-[10px] text-white/70"
                    >
                      {t}
                    </span>
                  ))}
              ...
              <div className="grid grid-cols-2 gap-y-6">
                <div>
                  <h4 className="font-mono text-[10px] tracking-[0.2em] uppercase text-white/30 mb-2">
                    Role
                  </h4>
                  <p className="font-geist text-[14px] text-white/80">
                    {project.role}
                  </p>
                </div>
                <div>
              ...
              <div className="flex flex-col gap-3">
                {project.liveUrl !== "#" && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-3 bg-white text-black font-mono text-[11px] tracking-[0.1em] uppercase rounded-none hover:bg-white/90 transition-colors"
                  >
                    Live Demo ↗
                  </a>
                )}
                {project.githubUrl !== "#" && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-3 border border-white/20 text-white font-mono text-[11px] tracking-[0.1em] uppercase rounded-none hover:bg-white/5 transition-colors"
                  >
                    Source Code ↗
                  </a>
                )}
